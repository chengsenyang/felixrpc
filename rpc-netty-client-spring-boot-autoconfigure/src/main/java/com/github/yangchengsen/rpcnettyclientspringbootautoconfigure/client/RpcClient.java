package com.github.yangchengsen.rpcnettyclientspringbootautoconfigure.client;
...
import com.github.yangchengsen.rpcnettycommon.bean.RpcRequest;
import com.github.yangchengsen.rpcnettycommon.bean.RpcResponse;
import com.github.yangchengsen.rpcnettycommon.bean.ServiceInfo;
import com.github.yangchengsen.rpcnettycommon.codec.decode.RemotingTransporterDecoder;
import com.github.yangchengsen.rpcnettycommon.codec.encode.RemotingTransporterEncoder;
import com.github.yangchengsen.rpcnettycommon.dispatcher.RemotingTransporterFuture;
import com.github.yangchengsen.rpcnettycommon.dispatcher.RequestPendingCenter;
import com.github.yangchengsen.rpcnettycommon.handler.RpcClientHandler;
import com.github.yangchengsen.rpcnettycommon.protocal.xuan.RemotingTransporter;
import com.github.yangchengsen.rpcnettycommon.route.RouteEngine;
            ...
            bootstrap.handler(new ChannelInitializer<SocketChannel>() {
                ...
                protected void initChannel(SocketChannel channel) throws Exception {
                    ...
                    pipeline.addLast(new RemotingTransporterDecoder())
                            ...
                            .addLast(new RpcClientHandler(requestPendingCenter));
                }
            });
            ChannelFuture future=bootstrap.connect(host,port).sync();
            Channel channel=future.channel();
            log.info("invokeId: "+remotingTransporter.getInvokeId());
            RemotingTransporterFuture remotingTransporterFuture = new RemotingTransporterFuture();
            requestPendingCenter.add(remotingTransporter.getInvokeId(), remotingTransporterFuture);
            //写入RPC请求对象
            channel.writeAndFlush(remotingTransporter);
            channel.closeFuture().sync();
            log.info("send end");
            //获取RPC响应对象
            RemotingTransporter res = remotingTransporterFuture.get();
            return (RpcResponse) res.getBodyContent();
